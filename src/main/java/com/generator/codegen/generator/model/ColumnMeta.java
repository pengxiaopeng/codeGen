package com.generator.codegen.generator.model;
...
public class ColumnMeta {
	...
	public String getPropertyType() {
		...
		if (StringUtils.startsWith(type, "int")) { // int/long
			...
			propertyType = "java.util.Date";
		} else if (StringUtils.startsWith(type, "blob")) {
			propertyType = "byte[]";
		} else if (StringUtils.startsWith(type, "longblob")) {
			propertyType = "byte[]";
		} else if (StringUtils.startsWith(type, "tinyint")) {
			propertyType = "java.lang.Integer";
		} else if (StringUtils.startsWith(type, "tinyblob")) {
			propertyType = "byte[]";
		} else if (StringUtils.startsWith(type, "smallint")) {
			propertyType = "java.lang.Integer";
		} else if (StringUtils.startsWith(type, "bit")) {
			propertyType = "java.lang.Boolean";
		} else if (StringUtils.startsWith(type, "decimal")) {
			propertyType = "java.math.BigDecimal";
		} else if (StringUtils.startsWith(type, "longtext")) {
