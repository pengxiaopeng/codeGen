{    
    "HEADER.BRAND" : "Activiti 编辑器",
    "HEADER.BRAND_TAGLINE" : "powered by Alfresco",
    "PAGE.HEADER" : "Orchestration Details",    "ACTION.OK" : "确认",
    "ACTION.SAVE" : "保存",
    ...
    "MAIN_NAVIGATION_SOLUTIONS" : "解决方案",
    
    "TOOLBAR.ACTION.CLOSE" : "关闭编辑器并且退回概述页面",
    "TOOLBAR.ACTION.SAVE" : "保存模版",
    "TOOLBAR.ACTION.VALIDATE": "校验模版",
    "TOOLBAR.ACTION.CUT" : "剪切 (在你的业务流程中选择一个或多个节点)",
    "TOOLBAR.ACTION.COPY" : "拷贝 (在你的业务流程中选择一个或多个节点)",
    "TOOLBAR.ACTION.PASTE" : "粘贴",
    "TOOLBAR.ACTION.DELETE" : "删除选择节点",
    "TOOLBAR.ACTION.UNDO" : "撤销",
    "TOOLBAR.ACTION.REDO" : "恢复",
    ...
    "TOOLBAR.ACTION.SAMESIZE" : "相同尺寸",
    "TOOLBAR.ACTION.HELP": "开始指引",
    "TOOLBAR.ACTION.FEEDBACK": "提供反馈",
    
    "KICKSTART.PROCESS_TOOLBAR.ACTION.SAVE" : "保存模版",
    "KICKSTART.PROCESS_TOOLBAR.ACTION.VALIDATE": "校验模版",
    "KICKSTART.PROCESS_TOOLBAR.ACTION.HELP": "开始指引",
    "KICKSTART.PROCESS_TOOLBAR.ACTION.FEEDBACK": "提供反馈",
    
    "FORM_TOOLBAR.ACTION.SAVE" : "保存模版",
    "FORM_TOOLBAR.ACTION.VALIDATE": "校验模版",
    "FORM_TOOLBAR.ACTION.HELP": "开始指引",
    "FORM_TOOLBAR.ACTION.FEEDBACK": "提供反馈",
    
    "APP_DEFINITION_TOOLBAR.ACTION.SAVE" : "保存应用定义",
    "APP_DEFINITION_TOOLBAR.ACTION.VALIDATE" : "校验应用定义",
    "APP_DEFINITION_TOOLBAR.ACTION.HELP" : "开始指引",
    "APP_DEFINITION_TOOLBAR.ACTION.FEEDBACK" : "提供反馈",
    
    "BUTTON.ACTION.DELETE.TOOLTIP": "从模版中删除元素",
    ...
    "PROPERTY.REMOVED" : "清楚",
    "PROPERTY.EMPTY" : "没有值",
    "PROPERTY.PROPERTY.EDIT.TITLE" : "\"{{title}}\"",

    "PROPERTY.FEEDBACK.TITLE" : "请填写您的反馈",
    ...
    "PROPERTY.ASSIGNMENT.ASSIGNEE" : "任务执行人",
    "PROPERTY.ASSIGNMENT.MATCHING" : "使用上下方向键选择并按回车键确认或使用鼠标",
    "PROPERTY.ASSIGNMENT.ASSIGNEE_PLACEHOLDER" : "请输入任务执行人",
    "PROPERTY.ASSIGNMENT.EMPTY" : "没有选中的任务执行人",
    "PROPERTY.ASSIGNMENT.ASSIGNEE_DISPLAY" : "任务执行人 {{assignee}}",
    ...
    "PROPERTY.ASSIGNMENT.IDM.DROPDOWN.USERS" : "候选人",
    ...
    "PROPERTY.FORMPROPERTIES.ID.PLACEHOLDER" : "输入Id",
    ...
    "PROPERTY.FORMPROPERTIES.ENUMVALUES.EMPTY" : "没有选中的枚举值",
    "PROPERTY.FORMPROPERTIES.VALUES.ID" : "Id",
    "PROPERTY.FORMPROPERTIES.VALUES.NAME" : "名称",
    "PROPERTY.FORMPROPERTIES.VALUES.ID.PLACEHOLDER" : "输入Id的值",
	"PROPERTY.FORMPROPERTIES.VALUES.NAME.PLACEHOLDER" : "输入名称的值",
    ...
    "PROPERTY.FORMPROPERTIES.REQUIRED" : "不可为空",
    ...
    "PROPERTY.FORMREFERENCE.FORM.EMPTY" : "这个文件夹不包含任何形式",
